...
# Version    : 0.1.19                                                                              #
# Python     : 3.10.10                                                                             #
# Filename   : /tests/test_sdoutlier.py                                                            #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
# Modified   : Friday May 19th 2023 11:33:28 am                                                    #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
from alterity.std import STDOutlier
...
@pytest.mark.std
class TestSTDOutlier:  # pragma: no cover
    # ============================================================================================ #
    def test_STDOutlier(self, caplog):
        start = datetime.now()
        logger.info(
        ...
        logger.debug(X)
        outlier = STDOutlier(threshold=3)
        outlier.fit(X=X)
